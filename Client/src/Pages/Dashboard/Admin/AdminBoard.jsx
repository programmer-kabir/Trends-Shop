    ...
    <div className="px-5 pt-7">
      ...
      <section className="md:flex pt-8 items-center gap-7 justify-between">
        <div className="flex  items-center justify-between bg-white shadow rounded-md px-6 w-full py-5">
          <div className="space-y-1 ">
            <h2 className="text-base font-semibold">10</h2>
        ...
        <div className="flex  items-center justify-between bg-white shadow rounded-md px-6 w-full py-5">
          <div className="space-y-1 ">
            <h2 className="text-base font-semibold">12</h2>
        ...
        <div className="flex  items-center justify-between bg-white shadow rounded-md px-6 w-full py-5">
          <div className="space-y-1 ">
            <h2 className="text-base font-semibold">4055</h2>
      ...
      <section className="md:flex gap-10 pt-7 p-2 items-center">
        ...
        <div className="md:w-[44%] pt-7 md:pt-0 p-2 flex flex-col">
